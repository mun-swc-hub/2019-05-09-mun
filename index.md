...
instructor: ["Joany Marino", "Ivo Arrey", "Oliver Stueker", "Emilie Geissinger"] 
# boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Abdula Abulaban", "Andrea Perreault", "Elnaz Bodaghkhani", "Oihane Cereceda", "Shreya Nemani" ]
# boxed, comma-separated list of helpers' names
...
collaborative_notes: https://etherpad.net/p/2019-05-09-mun            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: "60143919081"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
